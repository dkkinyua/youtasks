...
const Cards = () => {
	...
	const TaskCard = ({ task, handleCheckboxChange, hiddens }) => (
		...
		>
			...
			<div className="buttons w-8 flex justify-between">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 512 512"
					className="w-4 h-4 fill-red-700 cursor-pointer mt-2 mr-2"
					onClick={(e) => {
						console.log(task.id);
						setOpenupdate(true);
						setOpentask(task);
				...
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 448 512"
					className="w-4 h-4 fill-red-700 cursor-pointer mt-2"
					onClick={(e) => {
						e.preventDefault();
						deleteTask(task.id);
					}}
	...
	return (
		<>
			...
			>
				...
				>
					<h2 className="text-white text-xl  ">Done tasks</h2>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 448 512"
						className={`w-6 h-6 ml-auto cursor-pointer self-end relative justify-self-end fill-white ${!hidden ? "" : "hidden"}`}
					>
